...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 852588252
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMenu_Statics::NewProp_HostButton_MetaData[] = {
		{ "BindWidget", "" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/* This UPROPERTY specifier will look at the variable name we use for the button and look for a button in the widget\n\x09   that we have this class as a parent of for a button with the EXACT same name (There needs to be a button that\n\x09   is named \"HostButton\" and another that is named \"JoinButton\" for classes that use Menu as a parent class)*/" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "This UPROPERTY specifier will look at the variable name we use for the button and look for a button in the widget\n         that we have this class as a parent of for a button with the EXACT same name (There needs to be a button that\n         is named \"HostButton\" and another that is named \"JoinButton\" for classes that use Menu as a parent class)" },
#endif
	};
#endif
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_UdemyGames_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UdemyGames_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 1565019890U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UdemyGames_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_2508822886(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_UdemyGames_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UdemyGames_Blaster_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
